...
import com.example.teamplatform.model.enums.TeamStatusEnum;
...
import com.example.teamplatform.mapper.TeamMapper;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock("teamplatform:join_team");
        try {
            // 抢到锁并执行
            while (true) {
